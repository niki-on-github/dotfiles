...
if [ "$XDG_SESSION_TYPE" = "x11" ]; then
    export WINIT_X11_SCALE_FACTOR=1  # fix: same alacritty font size in X11 and wayland
fi
...
# fzf default colors (see https://github.com/junegunn/fzf/wiki/Color-schemes)
